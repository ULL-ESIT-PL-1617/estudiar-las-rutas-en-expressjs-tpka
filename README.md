# Direcciones de la Práctica: Estudiar las rutas en expressjs
...
En esta práctica se ha llevado a cabo un pequeño tutorial del uso de rutas en expressjs. Para consultar algunos de los ejemplos ilustrativos, cosultar el directorio [/scripts](/scripts).
